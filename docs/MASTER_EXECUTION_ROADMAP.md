...
| UI concept prototypes (1-20) | IN PROGRESS | Concepts 01-08 complete | `docs/ui/concepts/`, `esphome/concepts/` | Research and prototype all 20 concepts sequentially |
...
| Concept 08: Apple Watch Complications | IN REVIEW | PR pending | `docs/ui/concepts/08_apple_watch_complications/`, `esphome/concepts/door_side_concept_08_apple_watch_complications.yaml` | Compile PASSED; NOT RECOMMENDED for v1; v1-expanded adaptation; Hardik to review |
