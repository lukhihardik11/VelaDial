...
| Concept 18: Radar Sweep Animation | IN REVIEW | PR pending | `docs/ui/concepts/18_radar_sweep_animation/`, `esphome/concepts/door_side_concept_18_radar_sweep_animation.yaml` | Compile PASSED; Radar sweep metaphor; futuristic/scanning/premium; Hardik to review |
