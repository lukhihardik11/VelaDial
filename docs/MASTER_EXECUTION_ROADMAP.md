...
| UI concept prototypes (1-20) | IN PROGRESS | Concepts 01-13 complete | `docs/ui/concepts/`, `esphome/concepts/` | Research and prototype all 20 concepts sequentially |
...
| Concept 13: Lunar Phase Visualization | IN REVIEW | PR pending | `docs/ui/concepts/13_lunar_phase_visualization/`, `esphome/concepts/door_side_concept_13_lunar_phase_visualization.yaml` | Compile PASSED; Moon phase metaphor; poetic/premium; Hardik to review |
