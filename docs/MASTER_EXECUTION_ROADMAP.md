...
| UI concept prototypes (1-20) | IN PROGRESS | Concepts 01-07 complete | `docs/ui/concepts/`, `esphome/concepts/` | Research and prototype all 20 concepts sequentially |
...
| Concept 07: Text-First Utility | IN REVIEW | PR pending | `docs/ui/concepts/07_text_first_utility/`, `esphome/concepts/door_side_concept_07_text_first_utility.yaml` | Compile PASSED; v1 candidate; Hardik to review |
