...
| **Multi-Theme Firmware Engine (candidate)** | **IN REVIEW** | **PR #56** | `esphome/door_side_rotary.yaml`, `docs/ui/theme_visual_upgrade_plan.md`, `docs/ui/multi_theme_firmware_engine.md`, `docs/ui/theme_selector_ux.md` | **Compile-passing multi-theme firmware candidate**: 20 selectable themes in one binary, theme selector via long-press, shared control logic, persistent theme selection, theme-colored LED ring. Compile PASSED. Hardware validation pending. Further visual refinement may follow hardware testing. |
