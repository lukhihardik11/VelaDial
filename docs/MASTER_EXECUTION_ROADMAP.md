...
| UI concept prototypes (1-20) | IN PROGRESS | Concepts 01-02 in review | `docs/ui/concepts/`, `esphome/concepts/` | Research and prototype all 20 concepts sequentially |
...
| Concept 02: SmartKnob-Inspired Arc | IN REVIEW | Branch `ui/concept-02-smartknob-arc` | `docs/ui/concepts/02_smartknob_arc/`, `esphome/concepts/door_side_concept_02_smartknob_arc.yaml` | Compile PASSED; Hardik to review |
