...
| Concept 20: Eclipse Corona | IN REVIEW | PR pending | `docs/ui/concepts/20_eclipse_corona/`, `esphome/concepts/door_side_concept_20_eclipse_corona.yaml` | Compile PASSED; Eclipse corona metaphor; cinematic/premium/calm; FINAL CONCEPT; Hardik to review |
