...
| Concept 16: Topographic Contour Map | IN REVIEW | PR pending | `docs/ui/concepts/16_topographic_contour_map/`, `esphome/concepts/door_side_concept_16_topographic_contour_map.yaml` | Compile PASSED; Topographic contour metaphor; cartographic/premium; Hardik to review |
