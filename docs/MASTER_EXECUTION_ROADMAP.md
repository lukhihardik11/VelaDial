...
| Concept 19: Vinyl DJ Crossfader | IN REVIEW | PR pending | `docs/ui/concepts/19_vinyl_dj_crossfader/`, `esphome/concepts/door_side_concept_19_vinyl_dj_crossfader.yaml` | Compile PASSED; Vinyl turntable metaphor; audiophile/premium; Hardik to review |
