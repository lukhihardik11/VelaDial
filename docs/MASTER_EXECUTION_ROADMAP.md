...
| UI concept prototypes (1-20) | IN PROGRESS | Concepts 01-12 complete | `docs/ui/concepts/`, `esphome/concepts/` | Research and prototype all 20 concepts sequentially |
...
| Concept 12: Door Switch Replacement | IN REVIEW | PR pending | `docs/ui/concepts/12_door_switch_replacement/`, `esphome/concepts/door_side_concept_12_door_switch_replacement.yaml` | Compile PASSED; Full-screen power hero; guest-friendly; Hardik to review |
