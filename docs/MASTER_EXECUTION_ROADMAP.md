...
| Concept 17: Iris Aperture Mechanism | IN REVIEW | PR pending | `docs/ui/concepts/17_iris_aperture_mechanism/`, `esphome/concepts/door_side_concept_17_iris_aperture_mechanism.yaml` | Compile PASSED; Iris aperture metaphor; optical/mechanical/premium; Hardik to review |
