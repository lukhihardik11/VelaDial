...
| UI concept prototypes (1-20) | IN PROGRESS | Concepts 01-03 complete | `docs/ui/concepts/`, `esphome/concepts/` | Research and prototype all 20 concepts sequentially |
...
| Concept 03: Large Center Power Button | IN REVIEW | Branch `ui/concept-03-large-center-power` | `docs/ui/concepts/03_large_center_power_button/`, `esphome/concepts/door_side_concept_03_large_center_power.yaml` | Compile PASSED; Hardik to review |
